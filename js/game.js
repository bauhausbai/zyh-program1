var datas = {
	...
	game: {
		...
		// 每个奖励模块的名称列表
		bossRewardsNames: [
			"25核机芯", "0.1度恒温变频", "艺术化机身", "人工智能语音", "4K HDR+",
			"蓝牙4.0", "腾讯视频", "智能wifi远程控制", "十字科学空间", "智能控制多模式",
			"高品质保障", "智能远程控制", "一级能效变频", "健康除甲醛", "0.1度精微感"
		],
		// 最大核弹数量
		maxBombCount: 3,
...
var main = (function() {
	...
	return {
		...
		startGame: function(){
			...
			////重置模块奖励
			datas.game.bossRewards = actData.elements.map(function(value){
				return --value;
			});
			//alert(datas.game.bossRewards);
			//data.game.bossRewards = ["14"];
